    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        ...
        <button class="btn" ?disabled=${props.devicesLoading} @click=${props.onDevicesRefresh}>
          ${props.devicesLoading ? t("common.loading") : t("overview.refresh")}
        </button>
      </div>
      ${props.devicesError
            ...
            <div class="list" style="margin-top: 16px;">
              <div class="list-item">
                <div class="list-main">
                  ...
                  <div class="list-sub">${t("nodes.defaultBinding.sub")}</div>
                </div>
                <div class="list-meta">
                  <label class="field">
                  ...
                  ${!supportsBinding
                    ? html`<div class="muted">${t("nodes.noNodesWithExec")}</div>`
                    : nothing}
                </div>
              </div>
